...
2. Fill folder content blw dat with following files from the same game file folder as Step 1.: futuravailableunits.json , unitlines.json , unitcategories.json
