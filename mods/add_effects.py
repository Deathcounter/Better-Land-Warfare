...
def make_avail_effect (df: DatFile):
    ...
    logging.debug (f"Added Billman avail effect at {storage.billmanAvailID}")
    ...
    logging.debug (f"Added Lancer avail effect at {storage.lancerAvailID}")
    ...
    logging.debug (f"Added Dart Thrower avail effect at {storage.dartthrowerAvailID}")
...
def unit_upgrades_e (df: DatFile):
    ...
    logging.debug (f"Added Scyteman upgrade effect at {storage.billmanUpgradeIDs[0]}")
    ...
    logging.debug (f"Added Flailman upgrade effect at {storage.billmanUpgradeIDs[1]}")
    ...
    logging.debug (f"Added Heavy Lancer upgrade effect at {storage.lancerUpgradeID}")
    ...
    logging.debug (f"Added Knife Thrower upgrade effect at {storage.throwerUpgradeIDs[0]}")
